...
public class WorkView extends VerticalLayout {
    ...
    private boolean isManager; // Ez alapján döntjük el, hogy milyen gombok jelenjenek meg

    public WorkView(JobService jobService) {
        this.jobService = jobService;
        isManager = checkIfUserIsManager(); // Ez a metódus ellenőrzi a bejelentkezett felhasználó szerepkörét
